  ...
  return (
    <AssistantModalPrimitive.Root>
      <AssistantModalPrimitive.Anchor
        className={cn(
          "aui-root aui-modal-anchor fixed end-4 bottom-4 z-[60] size-11",
          anchorClassName,
        )}
      >
      ...
      <AssistantModalPrimitive.Content
        ...
        sideOffset={16}
        className={cn(
          "aui-root aui-modal-content data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-bottom-1/2 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:zoom-out data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-bottom-1/2 data-[state=open]:slide-in-from-right-1/2 data-[state=open]:zoom-in z-[70] h-[min(640px,calc(100dvh-5rem))] w-[min(420px,calc(100vw-2rem))] overflow-clip overscroll-contain rounded-xl border bg-popover p-0 text-popover-foreground shadow-md outline-none data-[state=closed]:animate-out data-[state=open]:animate-in [&>.aui-thread-root]:bg-inherit [&>.aui-thread-root_.aui-thread-viewport-footer]:bg-inherit",
          contentClassName,
        )}
      >
        <Thread />
...
>(({ "data-state": state, ...rest }, ref) => {
  const tooltip = state === "open" ? "Close tutor" : "Open AI tutor";
